                  ...
                  children: [
                    Container(
                      child: Column(
                        children: [
                          Image.network(
                            'https://asset.kompas.com/crops/ou0bI7L-uZPdsAHKth9sxnfOwis=/0x0:750x500/750x500/data/photo/2021/08/24/61250ce3507e5.jpg',
                            height: 100,
                            width: 100,
                          ),
                        ],
                    ...
                    Flexible(   
                        child: Text.rich(                        
                          TextSpan(
                            children: <TextSpan>[                            
                              TextSpan(
                                  text: 'Pashima Pleated \n',
                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                              TextSpan(                              
                                  text: 'Bahan : Ceruty Premium \nUkuran 175xa50(sudah di plisket) 175x75 (sebelum di plisket) \n\nMenggunakan material premium ceruty, bahan ini sudah menjadi salah satu material favorit untuk hijab pashima'),
                            ],
  ...
  showDialog(
    ...
    builder: (context) {
      return SimpleDialog(
        children: [
          Padding(
            padding: EdgeInsets.only(top: 10, left: 150.0, right: 150.0),
            child: Row(children: [
              Image.asset(
                'images/logo.png',
                height: 100,
